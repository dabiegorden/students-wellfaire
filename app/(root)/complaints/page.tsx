  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-[-20%] left-[10%] w-125 h-125 rounded-full bg-cug-green/5 blur-[120px]" />
        <div className="absolute bottom-[-10%] right-[5%] w-100 h-100 rounded-full bg-cug-green/5 blur-[100px]" />
        <div
        ...
        <div className="w-full max-w-2xl">
          ...
          >
            <div className="flex items-center gap-2 mb-4">
              <div className="w-8 h-0.5 bg-cug-green" />
            ...
            <h1 className="text-4xl font-bold text-foreground leading-tight mb-3">
              Submit a{" "}
              <span className="text-transparent bg-clip-text bg-linear-to-r from-cug-green to-teal-300">
                Complaint
              </span>
            </h1>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-foreground">
                  Complaint Title <span className="text-cug-green">*</span>
                </label>
                <input
                  type="text"
                  placeholder="e.g. Issues with exam grading in COMP301"
                  className="w-full px-4 py-3 bg-card/80 border border-border hover:border-border focus:border-cug-green/60 focus:ring-2 focus:ring-emerald-500/10 rounded-xl text-foreground placeholder-zinc-600 outline-none transition-all text-sm"
                  {...register("title")}
                />
                {errors.title && (
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-foreground">
                  Category <span className="text-cug-green">*</span>
                </label>
                <div className="grid grid-cols-3 gap-2">
                  {CATEGORIES.map((cat) => (
                    <label key={cat.value} className="relative cursor-pointer">
                      ...
                      />
                      <div className="flex flex-col items-center gap-1.5 px-3 py-3 bg-card/80 border border-border rounded-xl text-muted-foreground text-xs font-medium transition-all peer-checked:border-cug-green/60 peer-checked:bg-cug-green/5 peer-checked:text-cug-green hover:border-border hover:text-white">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <label className="text-sm font-medium text-foreground">
                    Description <span className="text-cug-green">*</span>
                  </label>
                ...
                <div className="relative">
                  <textarea
                    ...
                    rows={7}
                    className="w-full px-4 py-3 bg-card/80 border border-border hover:border-border focus:border-cug-green/60 focus:ring-2 focus:ring-emerald-500/10 rounded-xl text-foreground placeholder-zinc-600 outline-none transition-all text-sm resize-none"
              ...
              {/* Priority notice */}
              <div className="flex items-start gap-3 px-4 py-3 bg-card/60 border border-border/80 rounded-xl">
                <Sparkles className="w-4 h-4 text-cug-green mt-0.5 shrink-0" />
              ...
              <motion.button
                ...
                disabled={isLoading}
                whileTap={{ scale: 0.98 }}
                className="group w-full flex items-center justify-center gap-2 py-3.5 px-6 bg-linear-to-r from-cug-green to-cug-green-dark hover:from-cug-green hover:to-cug-green disabled:opacity-50 disabled:cursor-not-allowed text-foreground font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-cug-green/20 text-sm"
              >
                {isLoading ? (
                  <>
              ...
              <div className="text-center pt-2 border-t border-border/60">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1 text-cug-green hover:text-cug-green text-sm font-medium transition-colors"
                >
